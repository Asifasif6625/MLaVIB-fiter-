class script(object):
    START_TXT = """ഹലോ {}, <b>താങ്കളെ പരിചയപെട്ടതിൽ സന്തോഷം 🤗</b>
<i>ഞാനൊരു ലളിതമായ പ്രിമിയർ ആണ്. - ഫംഗ്ഷന് ചെയ്ത ഓട്ടോഫില്ട്ടര് ബോട്ട് 
ഗ്രൂപ്പിലൂടെ ഞാൻ നിങ്ങൾക്ക് നിരവധി സിനിമകൾ നൽകുന്നു.</i>
"""
    HELP_TXT = """ʜᴇʏ {}
ʜᴇʀᴇ ɪs ᴍʏ ʜᴇʟᴘ ᴄᴏᴍᴍᴀɴᴅs."""
    ABOUT_TXT = """○ 𝖬𝗒 𝖭𝖺𝗆e : ᴀᴜᴛᴏғɪʟᴛᴇʀ ʙᴏᴛ
○ 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href='https://t.me/Missmiya_bot'>𝙈𝙇𝙖𝙑𝙄𝘽 [𝑪𝒐𝒏𝒕𝒂𝒄𝒕]</a>
○ 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥 
...
- send message @Missmiya_bot.

<b>DEVS:</b>
- <a href=https://t.me/MLAVIB>𝙈𝙇𝙖𝙑𝙄𝘽 🔖official🔖</a>"""
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/MLAVIB)</code>

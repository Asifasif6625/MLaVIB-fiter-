...
async def gen_link_batch(bot, message):
    ...
    post = await bot.send_document(LOG_CHANNEL, f"batchmode_{message.from_user.id}.json", file_name="Batch.json", caption="𝗙𝗶𝗹𝗲𝘀𝘁𝗼𝗿𝗲 𝘀𝗵𝗿𝗶𝘆𝗮𝗮𝘆𝗶𝘁𝘁𝘂𝗻𝗱𝘂👍 <⚠️generated filestore⚠️>")
